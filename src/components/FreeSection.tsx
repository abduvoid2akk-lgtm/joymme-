...
export const FreeSection: React.FC<FreeSectionProps> = ({ listings }) => {
    ...
    <section className="space-y-6 pt-8 border-t border-black/5">
      <div className="flex items-center justify-between gap-4 px-4 md:px-0">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-[16px] md:rounded-2xl bg-emerald-100 flex items-center justify-center text-emerald-600 shadow-lg shadow-emerald-100 shrink-0">
            <Sparkles size={24} className="md:w-7 md:h-7" />
          </div>
          <div>
            <h2 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight uppercase">ODDIY E'LONLAR</h2>
            <p className="text-[10px] md:text-sm text-gray-500 font-medium">Siz uchun saralangan barcha takliflar</p>
          </div>
        </div>
